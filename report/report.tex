...
\title{A Reproducible Pipeline for Measuring Satellite Velocity \\
Anisotropy in IllustrisTNG-100}
...
validated pipeline and pilot analysis, not a claim of novel physics;
it is intended as a baseline for future population-level and
